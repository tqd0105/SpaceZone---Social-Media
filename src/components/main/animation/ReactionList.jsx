...
const ReactionList = ({
  ...
  return (
    <div
      ...
      className={`flex gap-2 m_flex-row absolute bottom-full left-0 bg-white rounded-2xl px-4 py-2 shadow-2xl animate__animated animate__zoomInLeft animate__faster`}
    >
